...
See [pgml.transform](../introduction/apis/sql-extensions/pgml.transform "mention") for examples of using transformers or [pgml.tune.md](../api/sql-extensions/pgml.tune.md "mention") for fine tuning.
