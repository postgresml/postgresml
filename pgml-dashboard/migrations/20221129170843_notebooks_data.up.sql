...
INSERT INTO notebooks VALUES (0, 'Tutorial 0: 🎉 Welcome to PostgresML!', '2022-08-19 18:47:08.93719', '2022-08-19 18:47:08.93719');
INSERT INTO notebooks VALUES (1, 'Tutorial 1: ⏱️ Real Time Fraud Detection', '2022-08-15 15:26:18.428227', '2022-08-15 15:26:18.428241');
INSERT INTO notebooks VALUES (2, 'Tutorial 2: ⚕️ Tumor Detection w/ Binary Classification', '2022-08-19 16:10:23.120983', '2022-08-19 16:10:23.120996');
INSERT INTO notebooks VALUES (3, 'Tutorial 3: ✍️ Handwritten Digit Image Classification', '2022-08-20 09:46:40.856497', '2022-08-20 09:46:40.856511');
INSERT INTO notebooks VALUES (4, 'Tutorial 4: 🍭 Diabetes Progression w/ Regression', '2022-08-19 19:18:14.608456', '2022-08-19 19:18:14.608474');
INSERT INTO notebooks VALUES (5, 'Tutorial 5: 🤗 Deep Learning w/ Transformers', '2022-08-20 09:47:47.830932', '2022-08-20 09:47:47.830946');
INSERT INTO notebooks VALUES (6, 'Tutorial 6: ↗️ Working w/ Embeddings', '2022-08-20 09:48:16.252016', '2022-08-20 09:48:16.252029');
INSERT INTO notebooks VALUES (7, 'Tutorial 7: 📒 Managing Model Deployments', '2022-08-20 09:48:40.044312', '2022-08-20 09:48:40.044325');
INSERT INTO notebooks VALUES (8, 'Tutorial 8: 💻 Working w/ the Internal Schema of PostgresML', '2022-08-20 09:49:41.363292', '2022-08-20 09:49:41.363306');
INSERT INTO notebooks VALUES (9, 'Tutorial 9: 🏁 Launch PostgresML w/ Your Production Stack', '2022-08-23 19:36:49.286982', '2022-08-23 19:36:49.286998');

SELECT pg_catalog.setval('notebooks_id_seq', (SELECT MAX(id) + 1 FROM notebooks), true);
...
INSERT INTO notebook_cells VALUES (1, 0, 1, 1, 1, '## Welcome!
...
INSERT INTO notebook_cells VALUES (5, 0, 3, 5, 1, 'SELECT ''Have a nice day!'' AS greeting;', NULL, NULL, NULL);
INSERT INTO notebook_cells VALUES (6, 1, 1, 1, 1, 'Introduction
------------
...
INSERT INTO notebook_cells VALUES (7, 1, 3, 2, 1, 'CREATE TABLE products (
  emoji TEXT PRIMARY KEY,
  name TEXT,
  price MONEY,
  perishable BOOLEAN
);', NULL, NULL, NULL);
INSERT INTO notebook_cells VALUES (8, 1, 3, 3, 1, 'INSERT INTO PRODUCTS (emoji, name, price, perishable) 
VALUES
  (''💰'', ''1oz gold bar'', ''$1999.99'', false),
  (''📕'', ''a tale of 2 cities'', ''$19.99'', false),
  (''🥬'', ''head of lettuce'', ''$1.99'', true)
RETURNING *;', NULL, NULL, NULL);
INSERT INTO notebook_cells VALUES (9, 1, 1, 4, 1, 'Now that we''re in business, our first customer has shown up, named Alice. She is a chef that owns a salad shop, so she is going to create an order for 1,000 🥬 `head of lettuce`.
...
INSERT INTO notebook_cells VALUES (10, 1, 3, 5, 1, 'CREATE TABLE orders (
...
INSERT INTO notebook_cells VALUES (11, 1, 1, 6, 1, 'Now that we have created the schema, we can record Alice''s order', '<article class="markdown-body"><p>Now that we have created the schema, we can record Alice''s order</p></article>', NULL, NULL);
INSERT INTO notebook_cells VALUES (12, 1, 3, 7, 1, 'INSERT INTO orders (customer_name) VALUES (''Alice'');
...
RETURNING *;', NULL, NULL, NULL);
INSERT INTO notebook_cells VALUES (13, 1, 1, 8, 1, '🔎 That inline subquery in #7 is a little weird.
...
INSERT INTO notebook_cells VALUES (14, 1, 3, 9, 1, 'CREATE TABLE payments (
  id BIGSERIAL PRIMARY KEY,
  order_id BIGINT,
  amount MONEY
);', NULL, NULL, NULL);
INSERT INTO notebook_cells VALUES (15, 1, 1, 10, 1, 'We''ll be doing a little bit of heavy lifting in the next query to calculate her payment total on the fly.', '<article class="markdown-body"><p>We''ll be doing a little bit of heavy lifting in the next query to calculate her payment total on the fly.</p></article>', NULL, NULL);
INSERT INTO notebook_cells VALUES (100, 8, 1, 4, 1, '## Projects
...
INSERT INTO notebook_cells VALUES (16, 1, 3, 11, 1, 'INSERT INTO payments (order_id, amount) 
...
GROUP BY 1
RETURNING *;', NULL, NULL, NULL);
INSERT INTO notebook_cells VALUES (17, 1, 1, 12, 1, '🎉 Time to celebrate! Alice has paid in full for our first order, and business is good.
...
INSERT INTO notebook_cells VALUES (18, 1, 3, 13, 1, 'INSERT INTO orders (customer_name) VALUES (''Bob'');
...
RETURNING *;', NULL, NULL, NULL);
INSERT INTO notebook_cells VALUES (19, 1, 1, 14, 1, 'Unfortunately, Bob makes his payment with a stolen credit card, but we don''t know that yet.', '<article class="markdown-body"><p>Unfortunately, Bob makes his payment with a stolen credit card, but we don''t know that yet.</p></article>', NULL, NULL);
INSERT INTO notebook_cells VALUES (20, 1, 3, 15, 1, 'INSERT INTO payments (order_id, amount) 
...
GROUP BY 1
RETURNING *;', NULL, NULL, NULL);
INSERT INTO notebook_cells VALUES (21, 1, 1, 16, 1, 'At the end of the month, the credit card company lets us know about the chargeback from the real card owner.  We''ll need to create another table to keep track of this.', '<article class="markdown-body"><p>At the end of the month, the credit card company lets us know about the chargeback from the real card owner.  We''ll need to create another table to keep track of this.</p></article>', NULL, NULL);
INSERT INTO notebook_cells VALUES (22, 1, 3, 17, 1, 'CREATE TABLE chargebacks (
  id BIGSERIAL PRIMARY KEY,
  payment_id BIGINT
)', NULL, NULL, NULL);
INSERT INTO notebook_cells VALUES (23, 1, 1, 18, 1, 'And now we can record the example of fraud', '<article class="markdown-body"><p>And now we can record the example of fraud</p></article>', NULL, NULL);
INSERT INTO notebook_cells VALUES (24, 1, 3, 19, 1, 'INSERT INTO chargebacks (payment_id) 
SELECT max(payments.id) AS payment_id
FROM payments 
JOIN orders ON payments.order_id = orders.id 
WHERE customer_name = ''Bob''
RETURNING *;', NULL, NULL, NULL);
INSERT INTO notebook_cells VALUES (25, 1, 1, 20, 1, '🏁 Congratulations! 🏁 
----------------
...
INSERT INTO notebook_cells VALUES (26, 1, 3, 21, 1, 'CREATE VIEW orders_summaries AS
SELECT 
...
INSERT INTO notebook_cells VALUES (27, 1, 1, 22, 1, 'Now, let''s have a look at the summary', '<article class="markdown-body"><p>Now, let''s have a look at the summary</p></article>', NULL, NULL);
INSERT INTO notebook_cells VALUES (28, 1, 3, 23, 1, 'SELECT * FROM orders_summaries;', NULL, NULL, NULL);
INSERT INTO notebook_cells VALUES (29, 1, 1, 24, 1, 'It''s intuitive that thieves will be more attracted to gold bars than a head of lettuce because the resell value is better. Perishable goods are more difficult to move on the black market. A good piece of information for our model would be the percentage of the order that is perishable. We call this a "feature" of the data model. We can construct a query to return this feature for each order, along with the chargeback label.', '<article class="markdown-body"><p>It''s intuitive that thieves will be more attracted to gold bars, than a head of lettuce because the resell value is better. Perishable goods are more difficult to move on the black market. A good piece of information for our model would be the percentage of the order that is perishable. We call this a "feature" of the data model. We can construct a query to return this feature for each order, along with the chargeback label.</p></article>', NULL, NULL);
INSERT INTO notebook_cells VALUES (30, 1, 3, 25, 1, 'CREATE VIEW fraud_samples AS
SELECT 
...
INSERT INTO notebook_cells VALUES (101, 8, 3, 5, 1, 'SELECT id, name, task::TEXT FROM pgml.projects LIMIT 10;', NULL, NULL, NULL);
INSERT INTO notebook_cells VALUES (158, 6, 3, 23, 1, 'SELECT pgml.distance_l2(ARRAY[1.0::real, 2.0, 3.0], ARRAY[4.0, 5.0, 6.0]);', NULL, NULL, NULL);
INSERT INTO notebook_cells VALUES (32, 1, 1, 27, 1, 'Training a model
----------------
...
INSERT INTO notebook_cells VALUES (33, 1, 3, 28, 1, 'SELECT * FROM pgml.train(
...
INSERT INTO notebook_cells VALUES (34, 1, 1, 29, 1, 'Oops. We''re going to get an error:
...
INSERT INTO notebook_cells VALUES (35, 1, 3, 30, 1, 'INSERT INTO orders (customer_name) VALUES (''Carol'');
...
RETURNING *;', NULL, NULL, NULL);
INSERT INTO notebook_cells VALUES (36, 1, 1, 31, 1, 'Carol has bought a book, and now will legitimately pay in full.', '<article class="markdown-body"><p>Carol has bought a book, and now will legitimately pay in full.</p></article>', NULL, NULL);
INSERT INTO notebook_cells VALUES (37, 1, 3, 32, 1, 'INSERT INTO payments (order_id, amount) 
...
GROUP BY 1
RETURNING *;', NULL, NULL, NULL);
INSERT INTO notebook_cells VALUES (38, 1, 1, 33, 1, 'And now Dan (another fraudster) shows up to steal more books:', '<article class="markdown-body"><p>And now Dan (another fraudster) shows up to steal more books:</p></article>', NULL, NULL);
INSERT INTO notebook_cells VALUES (39, 1, 3, 34, 1, 'INSERT INTO orders (customer_name) VALUES (''Dan'');
INSERT INTO line_items (
  order_id, 
  product_emoji, 
  count
...
RETURNING *;', NULL, NULL, NULL);
INSERT INTO notebook_cells VALUES (40, 1, 1, 35, 1, 'Here comes the fraudulent payment.', '<article class="markdown-body"><p>Here comes the fraudulent payment.</p></article>', NULL, NULL);
INSERT INTO notebook_cells VALUES (41, 1, 3, 36, 1, 'INSERT INTO payments (order_id, amount) 
...
GROUP BY 1
RETURNING *;', NULL, NULL, NULL);
INSERT INTO notebook_cells VALUES (42, 1, 1, 37, 1, 'And when the credit card company let''s us know about the issue, we''ll record it.', '<article class="markdown-body"><p>And when the credit card company let''s us know about the issue, we''ll record it.</p></article>', NULL, NULL);
INSERT INTO notebook_cells VALUES (43, 1, 3, 38, 1, 'INSERT INTO chargebacks (payment_id) 
SELECT max(payments.id) AS payment_id
FROM payments 
JOIN orders ON payments.order_id = orders.id 
WHERE customer_name = ''Dan''
RETURNING *;', NULL, NULL, NULL);
INSERT INTO notebook_cells VALUES (44, 1, 1, 39, 1, 'And now we can try to train the model again.', '<article class="markdown-body"><p>And now we can try to train the model again.</p></article>', NULL, NULL);
INSERT INTO notebook_cells VALUES (45, 1, 3, 40, 1, 'SELECT * FROM pgml.train(
...
INSERT INTO notebook_cells VALUES (46, 1, 1, 41, 1, '🏁 Success! 🏁
--------------
...
INSERT INTO notebook_cells VALUES (47, 1, 3, 42, 1, 'SELECT 
  perishable_percentage, 
  fraudulent, 
  pgml.predict(''Our Fraud Classification'', ARRAY[perishable_percentage::real]) AS predict_fraud 
FROM fraud_samples;', NULL, NULL, NULL);
INSERT INTO notebook_cells VALUES (130, 4, 3, 13, 1, 'SELECT * FROM pgml.train(
...
INSERT INTO notebook_cells VALUES (159, 6, 3, 24, 1, 'SELECT pgml.dot_product(ARRAY[1.0::real, 2.0, 3.0], ARRAY[4.0, 5.0, 6.0]);', NULL, NULL, NULL);
INSERT INTO notebook_cells VALUES (50, 1, 1, 45, 1, 'The default model is a linear regression, so it has learned from the training half of the data that high amounts of perishable goods make for safe orders.
...
INSERT INTO notebook_cells VALUES (51, 1, 3, 46, 1, 'DROP VIEW fraud_samples;
...
GROUP BY orders.id, chargebacks.id
ORDER BY orders.id;', NULL, NULL, NULL);
INSERT INTO notebook_cells VALUES (52, 1, 1, 47, 1, 'And now we retrain a new version of the model, by calling train with the same parameters again.', '<article class="markdown-body"><p>And now we retrain a new version of the model, by calling train with the same parameters again.</p></article>', NULL, NULL);
INSERT INTO notebook_cells VALUES (53, 1, 3, 48, 1, 'SELECT * FROM pgml.train(
  project_name => ''Our Fraud Classification'', -- a friendly name we''ll use to identify this machine learning project
  task => ''classification'', -- we want to classify into true or false
  relation_name => ''fraud_samples'', -- our view of the data
  y_column_name => ''fraudulent'', -- the "labels"
...
INSERT INTO notebook_cells VALUES (54, 1, 1, 49, 1, 'And then we can deploy this most recent version', '<article class="markdown-body"><p>And then we can deploy this most recent version</p></article>', NULL, NULL);
INSERT INTO notebook_cells VALUES (55, 1, 3, 50, 1, 'SELECT * FROM pgml.deploy(''Our Fraud Classification'', ''most_recent'');', NULL, NULL, NULL);
INSERT INTO notebook_cells VALUES (56, 1, 1, 51, 1, 'And view the input/outputs of this model based on our data:', '<article class="markdown-body"><p>And view the input/outputs of this model based on our data:</p></article>', NULL, NULL);
INSERT INTO notebook_cells VALUES (57, 1, 3, 52, 1, 'SELECT 
  perishable_amount, 
...
FROM fraud_samples;', NULL, NULL, NULL);
INSERT INTO notebook_cells VALUES (58, 1, 1, 53, 1, 'This is the basic development cycle for a model. 
...
INSERT INTO notebook_cells VALUES (59, 1, 1, 54, 1, 'Part 5: Upgrading the Machine Learning Algorithm
------------------------------------------
...
INSERT INTO notebook_cells VALUES (60, 1, 3, 55, 1, 'SELECT * FROM pgml.train(
  project_name => ''Our Fraud Classification'', -- a friendly name we''ll use to identify this machine learning project
  task => ''classification'', -- we want to classify into true or false
  relation_name => ''fraud_samples'', -- our view of the data
  y_column_name => ''fraudulent'', -- the "labels"
...
INSERT INTO notebook_cells VALUES (65, 2, 1, 1, 1, 'Binary classification means categorizing data into 2 categories. Usually these are categories like:
...
INSERT INTO notebook_cells VALUES (66, 2, 3, 2, 1, 'SELECT * FROM pgml.load_dataset(''breast_cancer'');', NULL, NULL, NULL);
INSERT INTO notebook_cells VALUES (67, 2, 1, 3, 1, 'This function has created a new table in your database named `pgml.breast_cancer`. Let''s look at a random sample of the data with some more SQL.', '<article class="markdown-body"><p>This function has created a new table in your database named <code>pgml.breast_cancer</code>. Let''s look at a random sample of the data with some more SQL.</p></article>', NULL, NULL);
INSERT INTO notebook_cells VALUES (68, 2, 3, 4, 1, 'SELECT * 
FROM pgml.breast_cancer 
ORDER BY random()
LIMIT 10;', NULL, NULL, NULL);
INSERT INTO notebook_cells VALUES (69, 2, 1, 5, 1, 'That''s a lot of numeric feature data describing various attributes of the cells, but if you scroll all the way to the right above, after running the query, you''ll see that each sample set of feature data is labeled `malignant` [`True` or `False`]. It would be extremely difficult for a human to study all these numbers, and see how they correlate with malignant or not, and then be able to make a prediction for new samples, but mathematicians have been working on algorithms to do exactly this using computers which happen to be exceptionally good at this by now. This is statistical machine learning.
...
INSERT INTO notebook_cells VALUES (70, 2, 3, 6, 1, 'SELECT * FROM pgml.train(
  project_name => ''Breast Cancer Detection'', 
  task => ''classification'', 
  relation_name => ''pgml.breast_cancer'', 
  y_column_name => ''malignant''
);', NULL, NULL, NULL);
INSERT INTO notebook_cells VALUES (71, 2, 1, 7, 1, '🏁 Congratulations 🏁
---------------------
...
INSERT INTO notebook_cells VALUES (72, 2, 3, 8, 1, 'SELECT malignant, pgml.predict(
...
INSERT INTO notebook_cells VALUES (74, 2, 3, 10, 1, 'SELECT sample_name, pgml.predict(
    ''Breast Cancer Detection'', 
    ARRAY[
        "mean radius", 
        "mean texture", 
...
INSERT INTO notebook_cells VALUES (78, 2, 3, 14, 1, '--
...
INSERT INTO notebook_cells VALUES (79, 2, 1, 15, 1, 'Turns out, computers are pretty fast these days, even with state of the art algorithms running on a free tier computation resources. 😊 
...
INSERT INTO notebook_cells VALUES (80, 2, 3, 16, 1, 'SELECT 
  projects.name,
  models.algorithm,
...
INSERT INTO notebook_cells VALUES (83, 4, 3, 2, 1, 'SELECT * FROM pgml.load_dataset(''diabetes'');', NULL, NULL, NULL);
INSERT INTO notebook_cells VALUES (84, 3, 1, 1, 1, 'Image classification is a great application of machine learning. In this tutorial we''ll examine a classic version of this problem, recognizing hand written digits to automatically parse zip codes out of addresses. For machine learning purposes, we decompose images into their uncompressed pixel values as 2D arrays for gray scale images, or 3D arrays for color images. 
...
INSERT INTO notebook_cells VALUES (93, 5, 1, 4, 1, '### Sentiment Analysis
...
INSERT INTO notebook_cells VALUES (88, 7, 1, 2, 1, '', '<article class="markdown-body"></article>', NULL, '2022-08-22 15:09:15.475779');
INSERT INTO notebook_cells VALUES (89, 8, 1, 1, 1, 'PostgresML stores all artifacts from training in the database under the `pgml` schema. You can manually inspect these tables to further understand the inner workings, or to generate additional reporting and analytics across your models.', '<article class="markdown-body"><p>PostgresML stores all artifacts from training in the database under the <code>pgml</code> schema. You can manually inspect these tables to further understand the inner workings, or to generate additional reporting and analytics across your models.</p></article>', NULL, NULL);
INSERT INTO notebook_cells VALUES (90, 3, 3, 2, 1, 'SELECT * FROM pgml.load_dataset(''digits'');', NULL, NULL, NULL);
INSERT INTO notebook_cells VALUES (91, 5, 1, 2, 1, '### Translation
...
INSERT INTO notebook_cells VALUES (92, 5, 3, 3, 1, 'SELECT pgml.transform(
...
INSERT INTO notebook_cells VALUES (94, 5, 3, 5, 1, 'SELECT pgml.transform(
...
INSERT INTO notebook_cells VALUES (95, 6, 1, 2, 1, '### Elementwise arithmetic w/ constants', '<article class="markdown-body"><h3>Elementwise arithmetic w/ constants</h3></article>', NULL, NULL);
INSERT INTO notebook_cells VALUES (96, 6, 3, 3, 1, '', NULL, NULL, '2022-08-22 15:14:31.875531');
INSERT INTO notebook_cells VALUES (97, 7, 3, 2, 1, '-- deploy the "best" model for prediction use
SELECT * FROM pgml.deploy(''Handwritten Digits'', ''best_score'');', NULL, NULL, NULL);
INSERT INTO notebook_cells VALUES (98, 8, 1, 2, 1, '## Models
...
INSERT INTO notebook_cells VALUES (99, 8, 3, 3, 1, 'SELECT id, algorithm::TEXT, runtime::TEXT FROM pgml.models LIMIT 10;', NULL, NULL, NULL);
INSERT INTO notebook_cells VALUES (155, 6, 3, 20, 1, 'SELECT pgml.normalize_max(ARRAY[1.0::real, 2.0, 3.0]);', NULL, NULL, NULL);
INSERT INTO notebook_cells VALUES (102, 8, 1, 6, 1, '## Snapshots
...
<p>Luckily, we have the benefit of the last 40 years of some very smart people developing a bunch of different algorithms for learning that all have different tradeoffs strengths and weaknesses. You could go spend a few years getting a degree trying to understand how they all work, or we can just try them all since computers are cheaper and more plentiful than engineers.</p></article>', NULL, NULL);
INSERT INTO notebook_cells VALUES (112, 3, 3, 12, 1, '--
-- After a project has been trained, omitted parameters will be reused from previous training runs
-- In these examples we''ll reuse the training data snapshots from the initial call.
--
...
INSERT INTO notebook_cells VALUES (116, 3, 3, 16, 1, 'SELECT * FROM pgml.train(
    ''Handwritten Digits'', 
    algorithm => ''svm'', 
...
INSERT INTO notebook_cells VALUES (117, 3, 1, 17, 1, 'And then we can peak at the metrics directly with a bit more SQL.', '<article class="markdown-body"><p>And then we can peak at the metrics directly with a bit more SQL.</p></article>', NULL, NULL);
INSERT INTO notebook_cells VALUES (118, 3, 3, 18, 1, 'SELECT metrics
FROM pgml.models
ORDER BY created_at DESC
LIMIT 1;', NULL, NULL, NULL);
INSERT INTO notebook_cells VALUES (119, 3, 1, 19, 1, 'It''s a bit tough to parse the results of the search in pure SQL, so you can hop over to the [Projects](../../projects/) list to see a visualization.', '<article class="markdown-body"><p>It''s a bit tough to parse the results of the search in pure SQL, so you can hop over to the <a href="../../projects/">Projects</a> list to see a visualization.</p></article>', NULL, NULL);
INSERT INTO notebook_cells VALUES (120, 4, 3, 3, 1, 'SELECT * 
FROM pgml.diabetes 
LIMIT 10;', NULL, NULL, NULL);
INSERT INTO notebook_cells VALUES (121, 4, 1, 4, 1, 'In this case, the `target` is a number that represents the severity of the disease progression one year later, with larger values indicating worse outcomes. Building a Regression model uses the same PostgresML API as Classification, just with a different task. You''re going to start breezing through these tutorials faster and faster.', '<article class="markdown-body"><p>In this case, the <code>target</code> is a number that represents the severity of the disease progression one year later, with larger values indicating worse outcomes. Building a Regression model uses the same PostgresML API as Classification, just with a different task. You''re going to start breezing through these tutorials faster and faster.</p></article>', NULL, NULL);
INSERT INTO notebook_cells VALUES (122, 4, 3, 5, 1, 'SELECT * FROM pgml.train(
  project_name => ''Diabetes Progression'', 
  task => ''regression'', 
  relation_name => ''pgml.diabetes'', 
  y_column_name => ''target''
);', NULL, NULL, NULL);
INSERT INTO notebook_cells VALUES (123, 4, 1, 6, 1, 'With our baseline model automatically deployed, we can sample some of the predictions', '<article class="markdown-body"><p>With our baseline model automatically deployed, we can sample some of the predictions</p></article>', NULL, NULL);
INSERT INTO notebook_cells VALUES (124, 4, 3, 7, 1, 'SELECT target, pgml.predict(''Diabetes Progression'', ARRAY[age, sex, bmi, bp, s1, s2, s3, s4, s5, s6]) AS prediction
FROM pgml.diabetes 
LIMIT 10;', NULL, NULL, NULL);
INSERT INTO notebook_cells VALUES (125, 4, 1, 8, 1, 'To get an objective measure of just how far off every single prediction is from the target, we can look at the key metrics recorded during training.', '<article class="markdown-body"><p>To get an objective measure of just how far off every single prediction is from the target, we can look at the key metrics recorded during training.</p></article>', NULL, NULL);
INSERT INTO notebook_cells VALUES (126, 4, 3, 9, 1, 'SELECT 
  projects.name,
  models.algorithm,
...
INSERT INTO notebook_cells VALUES (132, 5, 3, 7, 1, 'SELECT pgml.transform(
        ''summarization'',
        inputs => ARRAY[''
...
INSERT INTO notebook_cells VALUES (133, 5, 1, 8, 1, '### Question Answering
...
INSERT INTO notebook_cells VALUES (134, 5, 3, 9, 1, 'SELECT pgml.transform(
        ''question-answering'',
        inputs => ARRAY[
            ''{
...
INSERT INTO notebook_cells VALUES (135, 5, 1, 10, 1, '### Text Generation
...
INSERT INTO notebook_cells VALUES (136, 5, 3, 11, 1, 'SELECT pgml.transform(
        ''text-generation'',
        ''{"num_return_sequences": 2}'',
        ARRAY[''Three Rings for the Elven-kings under the sky, Seven for the Dwarf-lords in their halls of stone'']
    ) AS result;', NULL, NULL, NULL);
INSERT INTO notebook_cells VALUES (137, 5, 1, 12, 1, '### More
...
INSERT INTO notebook_cells VALUES (138, 6, 3, 3, 1, 'SELECT pgml.add(ARRAY[1.0::real, 2.0, 3.0], 3);', NULL, NULL, NULL);
INSERT INTO notebook_cells VALUES (139, 6, 3, 4, 1, 'SELECT pgml.subtract(ARRAY[1.0::real, 2.0, 3.0], 3);', NULL, NULL, NULL);
INSERT INTO notebook_cells VALUES (140, 6, 3, 5, 1, 'SELECT pgml.multiply(ARRAY[1.0::real, 2.0, 3.0], 3);', NULL, NULL, NULL);
INSERT INTO notebook_cells VALUES (141, 6, 3, 6, 1, 'SELECT pgml.divide(ARRAY[1.0::real, 2.0, 3.0], 100);', NULL, NULL, NULL);
INSERT INTO notebook_cells VALUES (142, 6, 1, 7, 1, '### Pairwise arithmetic', '<article class="markdown-body"><h3>Pairwise arithmetic</h3></article>', NULL, NULL);
INSERT INTO notebook_cells VALUES (143, 6, 3, 8, 1, 'SELECT pgml.add(ARRAY[1.0::real, 2.0, 3.0], ARRAY[4.0, 5.0, 6.0]);', NULL, NULL, NULL);
INSERT INTO notebook_cells VALUES (144, 6, 3, 9, 1, 'SELECT pgml.subtract(ARRAY[1.0::real, 2.0, 3.0], ARRAY[4.0, 5.0, 6.0]);', NULL, NULL, NULL);
INSERT INTO notebook_cells VALUES (145, 6, 3, 10, 1, 'SELECT pgml.multiply(ARRAY[1.0::real, 2.0, 3.0], ARRAY[4.0, 5.0, 6.0]);', NULL, NULL, NULL);
INSERT INTO notebook_cells VALUES (146, 6, 3, 11, 1, 'SELECT pgml.divide(ARRAY[1.0::real, 2.0, 3.0], ARRAY[4.0, 5.0, 6.0]);', NULL, NULL, NULL);
INSERT INTO notebook_cells VALUES (147, 6, 1, 12, 1, '### Norms', '<article class="markdown-body"><h3>Norms</h3></article>', NULL, NULL);
INSERT INTO notebook_cells VALUES (148, 6, 3, 13, 1, 'SELECT pgml.norm_l0(ARRAY[1.0::real, 2.0, 3.0]);', NULL, NULL, NULL);
INSERT INTO notebook_cells VALUES (149, 6, 3, 14, 1, 'SELECT pgml.norm_l1(ARRAY[1.0::real, 2.0, 3.0]);', NULL, NULL, NULL);
INSERT INTO notebook_cells VALUES (150, 6, 3, 15, 1, 'SELECT pgml.norm_l2(ARRAY[1.0::real, 2.0, 3.0]);', NULL, NULL, NULL);
INSERT INTO notebook_cells VALUES (151, 6, 3, 16, 1, 'SELECT pgml.norm_max(ARRAY[1.0::real, 2.0, 3.0]);', NULL, NULL, NULL);
INSERT INTO notebook_cells VALUES (160, 6, 3, 25, 1, 'SELECT pgml.cosine_similarity(ARRAY[1.0::real, 2.0, 3.0], ARRAY[1.0::real, 2.0, 3.0]);', NULL, NULL, NULL);
INSERT INTO notebook_cells VALUES (161, 6, 1, 26, 1, '### Generating Random Embeddings
...
INSERT INTO notebook_cells VALUES (162, 6, 3, 27, 1, 'CREATE TABLE embeddings AS
...
INSERT INTO notebook_cells VALUES (163, 6, 3, 28, 1, '-- Nearest neighbors to e1 using cosine similarity
SELECT 
    e1.id, 
    e2.id,
...
LIMIT 10;', NULL, NULL, NULL);
INSERT INTO notebook_cells VALUES (164, 7, 1, 3, 1, '## Rolling back to a specific algorithm
...
INSERT INTO notebook_cells VALUES (165, 7, 3, 4, 1, 'SELECT * FROM pgml.deploy(''Handwritten Digits'', ''rollback'', ''svm'');', NULL, NULL, NULL);
INSERT INTO notebook_cells VALUES (166, 8, 3, 7, 1, 'SELECT id, relation_name, test_sampling::TEXT FROM pgml.snapshots LIMIT 10;', NULL, NULL, NULL);
INSERT INTO notebook_cells VALUES (167, 8, 3, 8, 1, 'SELECT * FROM pgml.snapshot_1 LIMIT 10;', NULL, NULL, NULL);
INSERT INTO notebook_cells VALUES (168, 8, 1, 9, 1, '## Deployments
...
INSERT INTO notebook_cells VALUES (169, 8, 3, 10, 1, 'SELECT id, model_id, strategy::TEXT FROM pgml.deployments LIMIT 10;', NULL, NULL, NULL);
INSERT INTO notebook_cells VALUES (170, 9, 1, 1, 1, '## Native Installation
...
--
-- Name: notebook_cells_id_seq; Type: SEQUENCE SET; Schema:  Owner: lev
--

SELECT pg_catalog.setval('notebook_cells_id_seq', (SELECT MAX(id) + 1 FROM notebook_cells), true);
