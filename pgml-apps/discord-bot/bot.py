...
class Bot:
    ...
    def ingest(self, path: str, collection_name: str):
    ...
    def create_or_get_collection(self, collection_name: str):
        return self.pgml.create_or_get_collection(collection_name)
    ...
    def register_text_splitter(self, collection, chunk_size: int = 1500, chunk_overlap: int = 40):
    ...
    def start(self, collection_name: str, discord_token: str, channel_name: str):
