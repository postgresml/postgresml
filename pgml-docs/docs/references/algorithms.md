# Algorithms
We currently support the following regression and classification models from [Scikit-Learn](https://scikit-learn.org/) and [XGBoost](https://xgboost.readthedocs.io/).
