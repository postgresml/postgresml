...
class Model(BaseModel):
    ...
    def train(self):
        ...
        if self.project.task == "text-classification":
            ...
            self._algorithm["model"] = AutoModelForQuestionAnswering.from_pretrained(self.algorithm)
            ...
            self._algorithm["model"] = AutoModelForSeq2SeqLM.from_pretrained(self.algorithm)
