...
use crate::{
    model::Model, pipeline::Pipeline, splitter::Splitter, types::Json,
};

#[cfg(feature = "python")]
use crate::{
    model::ModelPython, pipeline::PipelinePython, splitter::SplitterPython,
    types::JsonPython,
};

/// A pipeline that processes documents
/// This has been deprecated in favor of [Pipeline]
// #[derive(alias, Debug, Clone)]
pub struct SingleFieldPipeline {
    pub name: String,
