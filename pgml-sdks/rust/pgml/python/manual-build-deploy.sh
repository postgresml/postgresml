...
cd ..
maturin publish -r $1 -i python3.11 --skip-existing -F python
# maturin publish -r $1 -i python3.8 -i python3.9 -i python3.10 -i python3.11 --skip-existing -F python
#maturin build --release --strip -i python3.8 -i python3.9 -i python3.10 -i python3.11 -o python/dist -F python
