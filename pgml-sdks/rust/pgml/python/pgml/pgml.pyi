...
class Collection:
	...
	async def generate_chunks(self, splitter_id: Optional[int] = 1) -> None
		...
	async def register_model(self, task: Optional[str] = "Default set in Rust. Please check the documentation.", model_name: Optional[str] = "Default set in Rust. Please check the documentation.", model_params: Optional[Dict[str, str]] = {}) -> None
		...
